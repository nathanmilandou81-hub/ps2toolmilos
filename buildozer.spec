...
requirements = python3,kivy,pyjnius,urllib3,certifi,charset-normalizer==3.3.2
...
android.permissions = READ_EXTERNAL_STORAGE,WRITE_EXTERNAL_STORAGE,MANAGE_EXTERNAL_STORAGE,INTERNET, (name=android.permission.WRITE_EXTERNAL_STORAGE;maxSdkVersion=18)
...
#       [app]
#       title = Ps2ToolMilos # This is not a comment, it is part of the title.
#
#   Warning: Indented text is treated as a multiline string - i.e.
#       [app]
#       title = Ps2ToolMilos
#          package.name = ps2toolmilos # This is all part of the title.
#
